...
<head>
  ...
  <title>Innovative Services | MENYA</title>
                ...
                <div class="col-md-6 ">
                  <div class="detail_box">
                    ...
                    <div class="btn-box">
                      ...
                      <a href="services.php" class="btn-2">
                        Explore
                      </a>
                    </div>
                  </div>
  ...
  <section class="service_section layout_padding">
    <div class="container-fluid">
      <div class="heading_container">
        ...
        <p>
          List of our comprehensive services that we provide.
        </p>
      </div>
      ...
      <div class="service_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
               All services that are offered from Rwanda Development Board.
            </p>
          </div>
        </div>
        <div class="box">
          <div class="img-box">
            <img src="images/rra.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
              RRA Services
            ...
            <p>
              All services that are offered from Rwanda Revenue Authority.
            </p>
          </div>
        </div>
        <div class="box">
          <div class="img-box">
            <img src="images/umucyo.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
              E-procurement
            ...
            <p>
              All services in relation with Umucyo E-Procurement services.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              All services that are related to brand identities and engaging messages.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              IT services that are in relation with web design, IT Training, Data entry and others.
            </p>
          </div>
        </div>
      </div>
      <div class="btn-box">
        <a href="service.php#service_section">
          Read More
        </a>
      </div>
    </div>
          ...
          <div class="container">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  "I am incredibly satisfied with MENYA's consultancy services, as their expertise, customized strategies, and exceptional support have played a pivotal role in driving the success of my business.
                </p>
          ...
          <div class="container">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  I am absolutely delighted with the marketing services provided by MENYA, as their innovative strategies, targeted campaigns, and exceptional execution have significantly elevated my business's brand presence, generated remarkable leads, and ultimately contributed to our tremendous growth.
                </p>
                <img src="images/quote.png" alt="">
              </div>
            </div>
          ...
          <div class="container">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                 I cannot express enough how satisfied I am with MENYA's online services for company registration, tax declaration, and other essential business needs. Their seamless and efficient processes, coupled with their expert guidance, have made navigating complex legal and financial requirements a breeze, allowing me to focus on growing my business with confidence.
                </p>
                <img src="images/quote.png" alt="">
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-8 mx-auto">
            <form method="post" action="sendusingphpmailer.php">
              <div class="form-row">
    ...
    <section class="container-fluid footer_section">
      <div class="container">
        <p>
          ...
          <a href="https://html.design/">Menya Business Services</a>
        </p>
      </div>
    </section>
    <!-- footer section -->
