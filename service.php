  ...
  <div class="service_container">
    <div class="box">
      ...
      <div class="detail-box">
        ...
        <p>
          Services that are offered from governmental bodies like RRA, RDB, RHA and many others.
        </p><a href="onlineservices.php">
        <button class="read-more-btn btn"  style="background-color:#d8bf36;">Read More</button></a>        
      </div>
    </div>
...
<div class="box">
      ...
      <div class="detail-box">
        ...
        <p>
          Marketing services such as billboards, transit advertising, digital marketing and many others.
        </p>
...
<!-- Modal -->
<div class="modal fade" id="servicesModal3" tabindex="-1" role="dialog" aria-labelledby="servicesModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="servicesModalLabel">List of Services</h5>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-8 mx-auto">
            <form action="sendusingphpmailer.php" method="POST">
              <div class="form-row">
          ...
          <div class="col-md-3">
            <div class="info_links">
              ...
              <ul class="  ">
                ...
                <li class="active">
                  <a class="" href="service.php"> Services <span class="sr-only">(current)</span></a>
                </li>
                <li class="">
