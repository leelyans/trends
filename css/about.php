          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="service.php#contactLink">Contact Us</a>
                </li>
              </ul>
            </div>
        ...
        <div class="col-md-6">
          <div class="detail-box">
            <div class="heading_container">
              <h3>
                Menya is a multidisciplinary Consultancy and marketing firm.
              </h3>
            </div>
            <p>
              MENYA CO Ltd, is a full service marketing agency operating in Rwanda. Since 2014, we have been adding value to Rwandan businesses by understanding rwandan consumers and effectively communicating with them. We have consistently provided exceptional services to businesses in Rwanda, helping them thrive in the competitive market by understanding the unique needs and preferences of Rwandan consumers.
            </p>
            <a href="#iwant">
              Read More
            </a>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <p class="section-title text-secondary">Menya<span></span></p>
                        <h1 class="mb-5">#1 Business Service firm in Kigali</h1>
                        <p class="mb-4">There is a wide range of services that we provide at our company which revolves around perfecting your business to gain spot light and raise their sales throught various marketing skills and experts and accounting specialists.</p>
                        ...
                        <div class="skill mb-4">
                            <div class="d-flex justify-content-between">
                                <p class="mb-2">Business Consultancy.</p>
                                <p class="mb-2">90%</p>
                            </div>
                            <div class="progress">
                        ...
                        <div class="skill mb-4">
                            <div class="d-flex justify-content-between">
                                <p class="mb-2">IT & Branding Services.</p>
                                <p class="mb-2">95%</p>
                            </div>
                            <div class="progress">
                        ...
                        <a href="" class="btn py-sm-3 px-sm-5 rounded-pill mt-3" style="background: #041858; color: white;">Read More</a>
                    </div>
                    <div class="col-lg-6">
          ...
          <div class="col-md-3">
            <div class="info_links">
              ...
              <ul class="  ">
                ...
                <li class="active">
                  <a class="" href="about.php"> About <span class="sr-only">(current)</span></a>
                </li>
                <li class="">
