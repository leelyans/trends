  ...
  <section class="work_section layout_padding">
    <div class="container">
      ...
      <div class="row" >
        <div class="col-md-6">
          <div class="img-box">
            <img src="images/project-38.jpg" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail_container">
            ...
            <div class="box b-1">
              <div class="top-box">
                ...
                <h5>
                  Appliacation for Tax clearence certificate, Quitus
                </h5>
              </div>
          ...
          <div class="box b-1">
              <div class="top-box">
                ...
                <h5>
                  Motorvehicle Transfer Services
                </h5>
              </div></div>
          ...
          <div class="box b-1">
              <div class="top-box">
                ...
                <h5>
                  Applications/assistance for tax issues
                </h5>
              </div>
      ...
      <div class="row" >
        <div class="col-md-6">
          <div class="img-box">
            <img src="images/logo-rha.webp" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail_container">
